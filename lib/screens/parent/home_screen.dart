              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(item.title ?? 'Başlık yok', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                    const SizedBox(height: 4),
                    Text(item.description ?? 'Açıklama yok', style: const TextStyle(color: AppTokens.textSecondaryLight, fontSize: 13)),
                  ],
                ),
              ),
            ],
