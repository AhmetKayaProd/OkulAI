...
import 'package:kresai/screens/teacher/setup_class_screen.dart';

/// Teacher - Kod Giriş Ekranı
class TeacherEnterCodeScreen extends StatefulWidget {
  const TeacherEnterCodeScreen({super.key});

  @override
  State<TeacherEnterCodeScreen> createState() => _TeacherEnterCodeScreenState();
}

class _TeacherEnterCodeScreenState extends State<TeacherEnterCodeScreen> {
  ...
  Future<void> _validateAndContinue() async {
    ...
    final isValid = _store.validateTeacherCode(code);
    ...
    if (isValid) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => TeacherSetupClassScreen(codeUsed: code),
        ),
      );
    } else {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Yöneticinizden aldığınız davet kodunu girin',
              style: TextStyle(
